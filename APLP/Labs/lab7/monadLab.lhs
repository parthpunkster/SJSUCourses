...
> testIncDec1 = Just 7 >>= mdecr >>= mdecr >>= mdecr >>= mincr >>= mdecr

Does bind seem more natural in this case than using do?  Why or why not?
Yes bind is more natural because we it makes us feel that we are directly binding it with mincr and mdecr.
